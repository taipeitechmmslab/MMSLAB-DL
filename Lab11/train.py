...
train_data, info = tfds.load(dataset, split=tfds.Split.TRAIN, data_dir='./dataset_celeb_a', with_info=True) # using training data
# train_data, info = tfds.load(dataset, split='train+validation+test', data_dir='./dataset_celeb_a', with_info=True) #Using training + validation + test data
